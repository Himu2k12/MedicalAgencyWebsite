...
@endcan
    ...
    <div class="sidebar-heading">
        ...
        <li class="nav-item {!! Request::is('categories') ? 'active':'' !!}">
            ...
            <div id="collapseTwo" class="collapse @if(Request::is('categories')|| Request::is('view-add-country-page') || Request::is('view-add-city-page') || Request::is('view-add-treatment-page') || Request::is('view-add-hospital-brand-page') || Request::is('view-add-hospital-page'))   show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">All Settings:</h6>
                    <a class="collapse-item {!! Request::is('categories') ? 'active':'' !!}" href="{{url('/categories')}}">Add Categories</a>
                    <a class="collapse-item {!! Request::is('view-add-country-page') ? 'active':'' !!}" href="{{url('view-add-country-page')}}">Add Country</a>
                    <a class="collapse-item {!! Request::is('view-add-city-page') ? 'active':'' !!}" href="{{url('/view-add-city-page')}}">Add City</a>
                    <a class="collapse-item {!! Request::is('view-add-hospital-brand-page') ? 'active':'' !!}" href="{{url('view-add-hospital-brand-page')}}">Add Hospital Brand</a>
                    <a class="collapse-item {!! Request::is('view-add-department-page') ? 'active':'' !!}" href="{{url('view-add-department-page')}}">Add Department</a>
                    <a class="collapse-item {!! Request::is('view-add-treatment-page') ? 'active':'' !!}" href="{{url('view-add-treatment-page')}}">Add Treatment</a>
                    <a class="collapse-item {!! Request::is('view-add-hospital-page') ? 'active':'' !!}" href="{{url('view-add-hospital-page')}}">Add Hospital</a>
                </div>
            </div>
        </li>
